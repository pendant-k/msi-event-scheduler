...
export default async function EventPage({ params }: { params: Promise<{ eventId: string }> }) {
  ...
  if (!activeSession) {
    return (
      <div className="mx-auto grid max-w-4xl gap-8 lg:grid-cols-[1fr_380px] lg:items-start">
        ...
        <form action={participantAccessAction} className="surface-flat space-y-3 p-4">
